...
const GenerativeAI = () => {
  return (
    <>
      <Helmet>
        <title>Generative AI Solutions | TechPivot</title>
        <meta name="description" content="Scale creative output with AI-generated text, images, code, video, and audio." />
        <link rel="canonical" href="https://techpivot.in/services/generative-ai" />
        <meta property="og:title" content="Generative AI Solutions | TechPivot" />
        <meta property="og:description" content="AI-powered content generation across text, image, code, video, and audio." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://techpivot.in/services/generative-ai" />
        <meta property="og:image" content="https://techpivot.in/og/services/generative-ai.jpg" />
        ...
        <meta name="twitter:title" content="Generative AI Solutions | TechPivot" />
        <meta name="twitter:description" content="AI-powered content generation across text, image, code, video, and audio." />
        <meta name="twitter:image" content="https://techpivot.in/og/services/generative-ai.jpg" />
          ...
          {`
            {
              ...
              "@type": "Service",
              "@id": "https://techpivot.in/services/generative-ai#service",
              "name": "Generative AI Solutions",
              "serviceType": "Content Generation",
              "description": "AI-generated text, images, code, video, and audio for creative scale.",
              "provider": {
                "@type": "Organization",
              ...
              "availableChannel": {
                "@type": "ServiceChannel",
                "serviceUrl": "https://techpivot.in/services/generative-ai"
              }
            }
          `}
        </script>
